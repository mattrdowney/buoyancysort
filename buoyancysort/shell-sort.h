...
namespace ShellSort
{
	...
	std::vector<long> pratt_technique7 =
	{
		...
		// Wondering how to determine the crossover point for switching to the next sequence? Take the prime and raise it to the power of its sequence e.g. 2^2, 3^3, 5^4, 7^5, 11^6 
