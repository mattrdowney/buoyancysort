...
namespace ShellSort
{
	...
	std::vector<long> modified_invisal2 =
	{
		1, 4, 10, 26, 65, 163, 407, 1017, 2543, 6358, 15894, 39736, 99341, 248353, 620882, 1552204, 3880511, 9701277, 24253192, 60632980
	};

	std::vector<long> modified_invisal3 =
	{
		1, 3, 9, 25, 64, 162, 406, 1016, 2542, 6357, 15893, 39735, 99340, 248352, 620881, 1552203, 3880510, 9701276, 24253191, 60632979, 151582449
	};

	std::vector<long> modified_invisal4 =
	{
		1, 4, 10, 25, 63, 157, 390, 967, 2398, 5946, 14747, 36573, 90700, 224937, 557845, 1383455, 3430969, 8508804, 21101835, 52332550
	};
