...
int main()
{
	...
	std::vector<long> gap_sequence2 = ShellSort::old_modified_tokuda2; //alternating between rounding up/down (does worse) // wait a second... all of my tests had gap sequences going up to 1M, not 10M (with the exception of the one that does the best due to being autogenerated), so it's not a fair comparison. 
