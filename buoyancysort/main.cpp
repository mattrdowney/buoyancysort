...
int main()
{
	...
	std::vector<long> gap_sequence2 = ShellSort::highway_13_and_23_shellsort_gap_sequence2;
	...
	ShellSort::empirical_comparison(gap_sequence1, gap_sequence2, 500000, 1000000, 10);
