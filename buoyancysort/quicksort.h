...
// If quicksort always went left to right you could shellsort right to left to have fewer cache missses (but, in practice, quicksort is implemented to recur on the smaller array first).
